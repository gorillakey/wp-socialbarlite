...
$( document ).ready(function() {
	...
	$('#colorSelector_background').ColorPicker({
		color: '#0000ff',
		...
		onChange: function (hsb, hex, rgb) {
			$('#colorSelector_background div').css('backgroundColor', '#' + hex);
			$('#FloatSocialBarBackground').val('#' + hex);
		}
	});

	$('#colorSelector_colortext').ColorPicker({
		color: '#0000ff',
		onShow: function (colpkr) {
			$(colpkr).fadeIn(500);
			return false;
		...
		onChange: function (hsb, hex, rgb) {
			$('#colorSelector_colortext div').css('backgroundColor', '#' + hex);
			$('#FloatSocialBarColortext').val('#' + hex);
		}
	});

	$('#active-switch').bootstrapSwitch('setSizeClass', '');
